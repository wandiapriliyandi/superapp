    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm rounded-4">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('spp/tagihan/update/' . $tagihan['id']) ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold text-danger">Nominal Diskon/Beasiswa (Rp)</label>
                        <input type="number" name="diskon" class="form-control form-control-lg rounded-3 border-0 bg-light text-danger fw-bold" value="<?= (int)$tagihan['diskon'] ?>">
                        <small class="text-muted">Isi jika santri mendapat potongan/beasiswa.</small>
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-bold">Keterangan Potongan</label>
                        <input type="text" name="keterangan_diskon" class="form-control rounded-3 border-0 bg-light" value="<?= $tagihan['keterangan_diskon'] ?>" placeholder="Contoh: Beasiswa KJP, Anak Guru, dll">
                    </div>
                    ...
                    <div class="d-flex justify-content-between gap-2">
                        <a href="<?= base_url('spp/tagihan') ?>" class="btn btn-light rounded-pill px-4">Batal</a>
