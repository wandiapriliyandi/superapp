            ...
            <div class="card-body">
                <div class="p-3 bg-light rounded-4 mb-4">
                    <div class="row">
                        ...
                        <div class="col-6 mb-2 text-end">
                            <small class="text-muted d-block">Potongan / Beasiswa</small>
                            <span class="fw-bold text-danger"><?= $tagihan['diskon'] > 0 ? '- Rp ' . number_format($tagihan['diskon'], 0, ',', '.') : '-' ?></span>
                            <?php if($tagihan['keterangan_diskon']): ?>
                                <br><small class="text-muted small fst-italic"><?= $tagihan['keterangan_diskon'] ?></small>
                            <?php endif; ?>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6 text-end">
                            <small class="text-muted d-block text-danger">Sisa Harus Bayar</small>
                            <span class="fw-bold text-danger">Rp <?= number_format($sisa, 0, ',', '.') ?></span>
                        </div>
                    </div>
                </div>

                <form action="<?= base_url('spp/pembayaran/save') ?>" method="post">
