...
<?= $this->section('breadcrumb') ?>
    <li class="breadcrumb-item"><a href="<?= base_url('keuangan') ?>" class="text-decoration-none">Keuangan</a></li>
    <li class="breadcrumb-item"><a href="<?= base_url('keuangan/tagihan') ?>" class="text-decoration-none">Tagihan</a></li>
<?= $this->endSection() ?>
