        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-header bg-danger text-white py-3">
                    <h5 class="mb-0 fw-bold"><i class="fas fa-arrow-up me-2"></i>Catat Kas Keluar (Pengeluaran)</h5>
                </div>
                <div class="card-body p-4">
                    <form action="<?= base_url('keuangan/jurnal/save_simple') ?>" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">Bayar Melalui (Kas/Bank)</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">Dibayar Untuk / Kategori Beban</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="nominal" class="form-control form-control-lg fw-bold text-danger" placeholder="0" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-bold">Keterangan</label>
                            <textarea name="keterangan" class="form-control" rows="2" placeholder="Contoh: Pembayaran listrik, Pembelian ATK, dll" required></textarea>
                        </div>
                        ...
                        <div class="d-grid">
                            ...
                            <a href="<?= base_url('keuangan') ?>" class="btn btn-link text-muted mt-2">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
